...
<head>
    ...
    <meta name="description" content="Mobile Number Verification Portal">
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .orb-1 { width:300px; height:300px; background:var(--purple); top:-80px; right:-80px; opacity:0.2; animation: orbFloat 8s ease-in-out infinite; }
        .orb-2 { width:250px; height:250px; background:var(--pink); bottom:-60px; left:-60px; opacity:0.2; animation: orbFloat 8s ease-in-out 4s infinite; }
        .orb-3 { width:180px; height:180px; background:var(--cyan); top:50%; left:50%; opacity:0.1; animation: orbPulse 5s ease-in-out infinite; }
        @keyframes orbFloat {
        ...
        .count-btns { display: flex; gap: 8px; margin-bottom: 25px; }
        .count-btn {
            flex: 1;
            padding: 12px;
        ...
        .count-btn:hover { border-color: var(--purple); color: #fff; background: rgba(139,92,246,0.15); }
        .count-btn.active {
        ...
        .submit-btn:hover { transform: translateY(-3px); box-shadow: 0 0 50px rgba(236,72,153,0.7); }
...
<body>
    ...
    <div class="card">
        ...
        <div class="status-msg <?php echo $msgType; ?> show"><?php echo $message; ?></div>
        <?php endif; ?>
    </div>
